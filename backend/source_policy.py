...
TRUSTED_PROVIDER_POLICIES: dict[str, ProviderPolicy] = {
    ...
    "redtube": ProviderPolicy("redtube", "RedTube", frozenset({"redtube.com", "www.redtube.com"})),
    "zzztube": ProviderPolicy("zzztube", "ZZZTube", frozenset({"zzztube.com", "www.zzztube.com"})),
    "pornhat": ProviderPolicy("pornhat", "PornHat", frozenset({"pornhat.one", "www.pornhat.one"})),
    "anyporn": ProviderPolicy("anyporn", "AnyPorn", frozenset({"anyporn.com", "www.anyporn.com"})),
    "voyeurhit": ProviderPolicy("voyeurhit", "VoyeurHit", frozenset({"voyeurhit.com", "www.voyeurhit.com"})),
    "porngo": ProviderPolicy("porngo", "Porngo", frozenset({"porngo.com", "www.porngo.com"})),
    "hdzog": ProviderPolicy("hdzog", "HDZog", frozenset({"hdzog.com", "www.hdzog.com"})),
    "sexplex": ProviderPolicy("sexplex", "SexPlex", frozenset({"sexplex.com", "www.sexplex.com"})),
    "vxxx": ProviderPolicy("vxxx", "VXXX", frozenset({"vxxx.com", "www.vxxx.com"})),
    "pornzog": ProviderPolicy("pornzog", "PornZog", frozenset({"pornzog.com", "www.pornzog.com"})),
    "porndr": ProviderPolicy("porndr", "PornDr", frozenset({"porndr.com", "www.porndr.com"})),
    "yourlust": ProviderPolicy("yourlust", "YourLust", frozenset({"yourlust.com", "www.yourlust.com"})),
    "pornobae": ProviderPolicy("pornobae", "Pornobae", frozenset({"pornobae.com", "www.pornobae.com"})),
    "bustybus": ProviderPolicy("bustybus", "BustyBus", frozenset({"bustybus.com", "www.bustybus.com"})),
    "bigfuck": ProviderPolicy("bigfuck", "BigFuck", frozenset({"bigfuck.tv", "www.bigfuck.tv"})),
    "hqporn": ProviderPolicy("hqporn", "HQPorn", frozenset({"hqporn.xxx", "www.hqporn.xxx"})),
    "milfporn": ProviderPolicy("milfporn", "MILFPorn", frozenset({"milfporn.tv", "www.milfporn.tv"})),
    "serviporno": ProviderPolicy("serviporno", "ServiPorno", frozenset({"serviporno.com", "www.serviporno.com"})),
    ...
    "mypornhere": ProviderPolicy("mypornhere", "MyPornHere", frozenset({"mypornhere.com", "www.mypornhere.com"})),
    "pussyspace": ProviderPolicy("pussyspace", "PussySpace", frozenset({"pussyspace.com", "www.pussyspace.com"})),
    "tubev": ProviderPolicy("tubev", "TubeV", frozenset({"tubev.sex", "www.tubev.sex"})),
    "xxxbule": ProviderPolicy("xxxbule", "XXXBule", frozenset({"xxxbule.com", "www.xxxbule.com"})),
    "theyarehuge": ProviderPolicy("theyarehuge", "TheyAreHuge", frozenset({"theyarehuge.com", "www.theyarehuge.com"})),
    "sexvid": ProviderPolicy("sexvid", "SexVid", frozenset({"sexvid.xxx", "www.sexvid.xxx"})),
    "pornid": ProviderPolicy("pornid", "PornID", frozenset({"pornid.xxx", "www.pornid.xxx"})),
    ...
    "porndoe": ProviderPolicy("porndoe", "PornDoe", frozenset({"porndoe.com", "www.porndoe.com"})),
}
