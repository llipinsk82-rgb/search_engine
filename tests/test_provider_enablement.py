...
def test_reaudited_live_providers_are_enabled():
    ...
    for name in ("spankbang", "thumbzilla", "xhamster", "pornhub", "tube8", "drtuber", "redtube", "zzztube", "pornhat", "anyporn", "pornzog", "porndr", "yourlust", "pornobae", "bustybus", "bigfuck", "hqporn"):
