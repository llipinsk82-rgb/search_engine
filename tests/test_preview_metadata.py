...
class PreviewMetadataTests(unittest.TestCase):
    ...
    def test_final_live_provider_set(self):
        self.assertEqual(
            ...
            {"beeg","xnxx","youjizz","pornone","hqporner","eporner","tnaflix","spankbang","thumbzilla","xhamster","pornhub","tube8","drtuber","redtube","zzztube","pornhat", "anyporn", "pornzog", "porndr", "yourlust", "pornobae", "bustybus", "bigfuck", "hqporn", "milfporn"},
        )
